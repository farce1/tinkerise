...
- [JSON Output](/tinkerise/reference/json-output) — machine-readable `--json` contract for read-only commands.
- [Shell Completions](/tinkerise/reference/completions) — bash, zsh, and fish tab-completion install and usage.
