...
3. Review framework details in the [Next.js guide](/guides/scaffolders/next/).

## Related guides

- [Next.js scaffolder guide](/guides/scaffolders/next/)
- [ESLint enhancement guide](/guides/enhancements/eslint/)
- [Prettier enhancement guide](/guides/enhancements/prettier/)
