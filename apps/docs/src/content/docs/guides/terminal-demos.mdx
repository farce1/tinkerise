...
![Terminal demo showing tinkerise scaffolding a Next.js app with TypeScript, Tailwind, and ESLint in one command flow](/media/demos/scaffold-next-golden-path.gif)
...
![Terminal demo showing tinkerise adding editorconfig enhancement and confirming the created .editorconfig file](/media/demos/add-quality-tooling.gif)
...
![Terminal demo showing tinkerise list output and focused web scaffolder discovery with Next.js, Vite, Astro, T3, Remix, TanStack Start, and Turborepo](/media/demos/list-web-catalog.gif)
...
![Terminal demo showing tinkerise doctor report a Python version issue, suggest a fix, and pass on rerun](/media/demos/doctor-recovery-check.gif)
